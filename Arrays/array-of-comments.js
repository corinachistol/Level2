...
const madison = users.find(user => user.firstName === "Madison")
console.log(madison.id)
...
const okGreatThanks = users.find(u => u.id == comments.find(comment => comment.text ==="OK great thanks").userId)
